 ...
 */
VimusMachineVideoPreview::VimusMachineVideoPreview()
{
    VimusMachineObject::initObject();

	this->label = string ("video");
 ...
 */
void VimusMachineVideoPreview::update()
{
	*(this->ppOutputData) = *(this->ppInputData);
 ...
 */
unsigned char** VimusMachineVideoPreview::getCurrentFramePointer()
{
 ...
 * another objects pin.
 */
bool VimusMachineVideoPreview::connectOutput (int outPin, VimusMachineObject * dstObj, int inPin)
{
 ...
 * objects pin.
 */
bool VimusMachineVideoPreview::connectInput (VimusMachineObject * srcObj, int outPin, int inPin)
{
	bool ret = false;
 ...
 * another objects pin.
 */
void VimusMachineVideoPreview::disconnectOutput (int outPin, VimusMachineObject * dstObj, int inPin)
{
 ...
 * another objects pin.
 */
void VimusMachineVideoPreview::disconnectInput (VimusMachineObject * srcObj, int outPin, int inPin)
{
